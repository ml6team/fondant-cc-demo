...
load_from_hub_op = ComponentOp(
    component_spec_path="components/load_from_hub_stack",
    arguments={"dataset_name": "ml6team/the-stack-smol-python"},
)
filter_metadata_op = ComponentOp(
    component_spec_path="components/filter_metadata",
    arguments={
...
comments_filtering_op = ComponentOp(
    component_spec_path="components/comments_filtering",
    arguments={
...
#     component_spec_path="components/your_custom_component",
#     arguments={},  # TODO: insert your component's arguments here
# )

pii_redaction_op = ComponentOp(
    component_spec_path="components/pii_redaction",
)
